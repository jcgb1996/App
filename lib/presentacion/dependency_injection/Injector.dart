...
import 'package:our_future/presentacion/dependency_injection/depen_app_logic/depen_app_store_logic.dart';
...
void setupInjector() {
  ...
  locator.registerFactory<DomStoreLogic>(() => InfraStoreLogic());
  ...
  locator.registerSingleton(
      DepenAppStoreLogic(repository: locator.get<DomStoreLogic>()));
}
